...
const CreateLinkToken = async ()=>{
    ...
    const response = await fetch(`${"https://localhost:8001"}/api/create_link_token`, {
        method: "POST"
    });
    // Error handling
    if (!response.ok) {
...
const PlaidButton = ({ text , customCSS , removeOldItem  })=>{
    ...
    const domain = "https://localhost:8001";
    ...
    const openPlaid = async ()=>{
        if (removeOldItem) {
            const deleteItemResponse = await fetch(`${"https://localhost:8001"}/account/delete-item`, {
                method: "DELETE",
                headers: {
    ...
    const { open , ready  } = (0,external_react_plaid_link_namespaceObject.usePlaidLink)({
        ...
        onSuccess: (public_token, metadata)=>{
            ...
            const setAccessToken = async ()=>{
                const response = await fetch(`${"https://localhost:8001"}/api/set_access_token`, {
                    method: "POST",
                    headers: {
                ...
                const postItemsResponse = await fetch(`${"https://localhost:8001"}/account/create-item`, {
                    method: "POST",
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json"
...
function CreditCards({ selected  }) {
    ...
    const viewTransactions = async (access_token, accountId)=>{
        ...
        const getTransactionsResponse = await fetch(`${"https://localhost:8001"}/api/transactions/${access_token}/${startDateFormat}/${endDateFormat}`, {
            method: "GET"
        });
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    bankAccounts.map((bankAccount)=>/*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                            children: !bankAccount.error && /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                                children: [
                                    bankAccount.accounts.findIndex((object)=>object.subtype === "credit card") === 0 && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        className: "my-24",
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                className: "mb-2 text-sm font-medium text-neutral-400",
                                    ...
                                    bankAccount.accounts.findIndex((object)=>object.subtype === "checking") === 0 && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        className: "my-24",
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                className: "mb-2 text-sm font-medium text-neutral-400",
...
const Categories = ({ category , display  })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "w-full h-auto p-6 mt-2 bg-neutral-800/20 rounded-xl",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                ...
                                children: "View your recent expenses:"
                            }),
                            category.transactions.map((transaction, index)=>/*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                                    children: index < renderAmount && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        className: "mb-6",
                                        children: [
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
                                                className: "my-2 text-sm text-neutral-600",
                                                children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                className: `flex items-center justify-between px-4 py-3 ${handleAmount(transaction.amount) ? "bg-red-400 bg-opacity-[3%]" : "bg-green-200 bg-opacity-[3%]"} rounded-xl`,
                                                children: [
                                                    /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                                                    ...
                                                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                        className: `${handleAmount(transaction.amount) ? "text-red-500" : "text-green-500"}`,
                            ...
                            category.transactions.length > 3 && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                onClick: ()=>setRenderAmount(renderAmount === 3 ? 1000 : 3),
                                children: /*#__PURE__*/ jsx_runtime_.jsx(Button/* default */.Z, {
                                    text: renderAmount === 3 ? "View all my expenses" : "View less expenses ",
                                    customCSS: "bg-red-500/25 mt-5 w-auto",
                                    setRenderAmount: setRenderAmount
                                })
                            })
                        ]
                    })
...
const CreditLiabilityBox = ({ displayAmount , userLocale , display , penalty  })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "w-full col-span-6 p-6 bg-red-600 rounded-xl",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
...
const CheckingInfoBox = ({ displayAmount , display , userLocale  })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "col-span-4 p-6 bg-red-600 rounded-xl xl:col-span-1",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                className: "text-base font-medium text-neutral-300",
...
const TotalEarnedBox = ({ display , timeframe , userLocale  })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "col-span-2 p-6 bg-indigo-600 rounded-xl xl:col-span-1",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
...
const TotalSpendBox = ({ display , timeframe , userLocale  })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "col-span-2 p-6 bg-sky-600 rounded-xl xl:col-span-1",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("span", {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                className: "grid w-full grid-cols-4 gap-3 my-2 xl:grid-cols-3 rounded-xl",
                                children: [
...
const getItemInfo_https = __webpack_require__(5687);
const getItemInfo = async (userAccounts)=>{
    const accountInfo = await Promise.all(userAccounts.map(async (account)=>{
        const getItemResponse = await fetch(`${process.env.DOMAIN}/api/item/${account.access_token}`, {
            method: "GET",
            // FOR DEV TESTING PURPOSES
            agent: new getItemInfo_https.Agent({
                rejectUnauthorized: false
            })
        });
...
const getAccountLiabilities = async (accounts)=>{
    const accountLiabilities = await Promise.all(accounts.map(async (account)=>{
        const getLiabilities = await fetch(`${process.env.DOMAIN}/api/liabilities/${account.access_token}`, {
            method: "GET",
            // FOR DEV TESTING PURPOSES
            agent: new getAccountLiabilities_https.Agent({
                rejectUnauthorized: false
            })
        });
                ...
                children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        ...
                                        children: debtDueSoon?.map((debt, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                                                children: [
                                                    debt?.due > 0 && /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                                ...
                                                                children: debt.statement ? "Statement balance" : "Total balance"
                                                            }),
                                                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                                className: "text-2xl font-medium text-white",
                                                                children: debt.statement?.toLocaleString(userLocale, {
                                                                    style: "currency",
                                                    ...
                                                    /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                                                        children: debtDueSoon.length > 1 && /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                                                            children: !debt?.due === 0 && /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                                className: "text-white",
                                                                children: "Some card"
                                                            })
                                                        })
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        children: bankAccounts.map((bankAccount)=>/*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
                                children: bankAccount.error && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                    className: "grid grid-cols-1 gap-16 p-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 bg-neutral-700/10 rounded-xl",
                                    children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        className: "flex flex-col items-start justify-center w-full grid-cols-1 px-4 py-6 transition rounded-lg bg-neutral-800 hover:shadow-md",
                                        children: [
...
function Home({ jwtDecodedUser , userAccounts , transactionsSort  }) {
    const { setSignedUser  } = (0,external_react_.useContext)(context_signedUser/* UserContext */.S);
    const { tab  } = (0,external_react_.useContext)(currentTab/* TabContext */.q);
    const { theme  } = (0,external_react_.useContext)(themePreference/* ThemeContext */.N);
    const { bankAccounts , setBankAccounts  } = (0,external_react_.useContext)(creditcards/* ItemsContext */.c);
...
const getServerSideProps = async (context)=>{
    ...
    try {
        ...
        if ((0,external_jsonwebtoken_namespaceObject.verify)(userJWT, process.env.ACCESS_TOKEN_SECRET)) {
            const userAccounts = await getUserItems((0,external_jsonwebtoken_namespaceObject.decode)(userJWT).userId);
            ...
            return {
                props: {
                    jwtDecodedUser: (0,external_jsonwebtoken_namespaceObject.decode)(userJWT),
                    userAccounts: formatAccounts || null
                }
            };
        }
        throw error;
